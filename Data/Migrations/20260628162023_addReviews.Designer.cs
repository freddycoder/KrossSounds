...
namespace KrossSounds.Migrations
{
    ...
    [Migration("20260628162023_addReviews")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KrossSounds.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("KrossSounds.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("KrossSounds.Models.Sound", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("KrossSounds.Models.Review", b =>
                {
                    b.HasOne("KrossSounds.Models.Sound", "Sound")
                        .WithMany("Reviews")
            ...
            modelBuilder.Entity("KrossSounds.Models.Sound", b =>
                {
                    b.HasOne("KrossSounds.Data.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("KrossSounds.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
